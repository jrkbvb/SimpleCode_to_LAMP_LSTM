...
class SavedLSTM(object):
	def __init__(self, model, user_input_args, data_info_args, wave_mean, wave_std):
...
def save_lstm_info(model, user_input_args, data_info_args, wave_mean, wave_std):
	saved_lstm = SavedLSTM(model, user_input_args, data_info_args, wave_mean, wave_std)
	# Save the file
...
def load_lstm_info(user_input_args):
	...
	return network, loaded_lstm.wave_mean, loaded_lstm.wave_std